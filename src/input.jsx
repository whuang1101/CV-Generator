  ...
  return (
    <>
      ...
      <div className={personal.detail}>
        <div className="title">
          <div className="icon">{personalItem}</div>
      ...
      <div className={[personal.display, "personal-details"].join(" ")}>
        <div className="name">
          <div className="personal-title">Full Name:</div>
          <input
            type="text"
        ...
        <div className="phone">
          <div className="personal-title">Phone number:</div>
  ...
  return (
    <>
      <div className="display-top">
        <div className="display-name">{window.name}</div>
        <div className="display-personal">
          <div className="display-email"></div>
          <div className="display-phone"></div>
          <div className="display-address"></div>
        </div>
      </div>
